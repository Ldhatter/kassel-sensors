...
public class ThreadPool {
	...
	public static void main(String[] args) {
		...
		MongoClient client = new MongoClient(
				new MongoClientURI("mongodb://kasselpi:kpi@ds129442.mlab.com:29442/kpisensors")); // store elsewhere
		...
		sensorsDB.find(new Document()).forEach(
				new Block<Document>() {
				       @Override
				       public void apply(final Document document) {
				           ...
				           sensors.add(new Sensor(loc, lat, lng));
